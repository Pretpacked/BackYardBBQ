...
class BarbecueRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Barbecue $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Barbecue $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return Barbecue[] Returns an array of Barbecue objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Barbecue
    {
        return $this->createQueryBuilder('b')
            ->andWhere('b.exampleField = :val')
            ->setParameter('val', $value)
